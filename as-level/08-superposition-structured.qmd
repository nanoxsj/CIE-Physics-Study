...
The distance S$_1$S$_2$ is $d$, and the distance between the double slit and the screen is $D$, where $D \gg d$, so angles $lpha$ and $	heta$ are small.
